...
test('exports a class', () => {
    const subject = new index_1.JsonCalendar();
    expect(subject instanceof index_1.JsonCalendar).toBe(true);
});
test('has day names', () => {
    const subject = new index_1.JsonCalendar();
...
test('uses given today param', () => {
    ...
    const calendar = new index_1.JsonCalendar({ today });
...
test('uses given today param and abbr', () => {
    const today = new Date(2018, 12, 31, 0, 0);
    const calendar = new index_1.JsonCalendar({ abbreviate: 0, today });
...
test('uses given today param, language, and abbr', () => {
    const today = new Date(2018, 12, 31, 0, 0);
    const calendar = new index_1.JsonCalendar({
        abbreviate: 3,
        languageCode: 'fr',
        today
    });
...
test('displays October 2018 correctly', () => {
    ...
    const calendar = new index_1.JsonCalendar({ year: 2018, monthIndex: 9, today });
...
describe('language parameter in constructor', () => {
    test('constructor optionally accepts a language', () => {
        let calendar = new index_1.JsonCalendar({ languageCode: 'fr' });
        expect(calendar.options.languageCode).toBe('fr');
        calendar = new index_1.JsonCalendar();
    ...
    test('optional language param accept french or spanish, otherwise defaults to english', () => {
        let calendar = new index_1.JsonCalendar({ languageCode: 'es' });
        expect(calendar.options.languageCode).toBe('es');
        calendar = new index_1.JsonCalendar({ languageCode: 'fr' });
        expect(calendar.options.languageCode).toBe('fr');
        calendar = new index_1.JsonCalendar({ languageCode: 'esperanto' });
        expect(calendar.options.languageCode).toBe('en');
    });
});
describe('language for months name', () => {
    test('should return french month names', () => {
        const calendar = new index_1.JsonCalendar({ languageCode: 'fr' });
    ...
    test('should return spanish month name', () => {
        const calendar = new index_1.JsonCalendar({ languageCode: 'es' });
